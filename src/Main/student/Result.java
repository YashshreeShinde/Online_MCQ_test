...
//		}
	...
	private Panel makeResult()
	{
		...
		lblSrno.setFont(new Font("Franklin Gothic Book", Font.PLAIN, 18));
		...
		for(int i=0;i<noOfCol;i++)
		{
			...
			lblColHead[i].setFont(new Font("Franklin Gothic Book", Font.PLAIN, 18));
